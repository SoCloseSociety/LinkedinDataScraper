...
username = os.getenv('LINKEDIN_USERNAME') or input('Enter your linkedin Email : ')
password = os.getenv('LINKEDIN_PASSWORD') or getpass('Enter your linkedin Password : ')
file_name = os.getenv('FILE_NAME') or input('Enter your file name : ')
